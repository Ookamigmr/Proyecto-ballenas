...
namespace AgregarUsuarios
{
    public partial class DatosInvestigador : UserControl, Interfacecita
    {
        ...
        private void IrCreandoUsuario()
        {
            ...
            {
                Contenedor.usuario = new ConexiónSQL.Usuario(txt_NombreUsuario.Text, txt_Contraseña.Text, txt_NombreInvestigador.Text, txt_Apellidos.Text,cbx_admin.Checked);
            }
            else
            {
                Contenedor.usuario = new ConexiónSQL.Usuario(txt_NombreUsuario.Text, txt_Contraseña.Text, txt_NombreInvestigador.Text, txt_Apellidos.Text, cmb_titulo.Text, cbx_admin.Checked);
            }
        }
